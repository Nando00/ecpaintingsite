...
import PaintingBackground from "common/assets/image/banner-background-image-esteban.jpg"; // Corrected import
...
const BannerWrapper = styled.div`
  position: relative; // Important to make sure Overlay can be positioned absolutely within it
  padding-top: 30px;
  margin-bottom: 81px;
  background-color: ${themeGet("colors.banner", "#171717")};

  background-image: url(${PaintingBackground?.src}); /* Use the src property */
...
export const ContentArea = styled.div`
  position: relative; // This ensures ContentArea is above the Overlay
  z-index: 2; // Ensure it's higher than the Overlay component
